                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'pxpy7xvu' /* Let's get started by filling o... */,
                                                  ),
                                                  textAlign: TextAlign.start,
                                              ...
                                              if (_model.passwordisntfieldsSmae)
                                                Padding(
                                                  padding: const EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 4.0, 0.0, 24.0),
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '3mo9mss1' /* Both password fields must have... */,
                                                    ),
                                                    textAlign: TextAlign.start,
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'j5vaotj3' /* Fill out the information below... */,
                                                  ),
                                                  textAlign: TextAlign.start,
                                                  style: FlutterFlowTheme.of(
                                                          context)
