                      ...
                      builder: (context) {
                        return WebViewAware(
                          child: GestureDetector(
                            ...
                            child: Padding(
                              padding: MediaQuery.viewInsetsOf(context),
                              child: const ChangProfileWidget(),
                            ),
                          ),
                        );
                      },
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    ...
                    await actions.handleNotificationPermission();
                  },
                  child: Container(
                    width: double.infinity,
                    height: 60.0,
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'e5cs3bdo' /* Notification Settings */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyLarge
                                    .override(
                      ...
                      builder: (context) {
                        return WebViewAware(
                          child: GestureDetector(
                            ...
                            child: Padding(
                              padding: MediaQuery.viewInsetsOf(context),
                              child: const ChangLangaugeWidget(),
                            ),
                          ),
                        );
                      },
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    if (animationsMap['containerOnActionTriggerAnimation6'] !=
                        null) {
                      setState(() => hasContainerTriggered6 = true);
                      SchedulerBinding.instance.addPostFrameCallback(
                          (_) async => await animationsMap[
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    if (animationsMap['containerOnActionTriggerAnimation7'] !=
                        null) {
                      setState(() => hasContainerTriggered7 = true);
                      SchedulerBinding.instance.addPostFrameCallback(
                          (_) async => await animationsMap[
